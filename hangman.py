...
word_list = ['abruptly', 'absurd', 'abyss', 'affix', 'askew', 'avenue', 'awkward', 'axiom', 'azure', 'bagpipes',
             ...
             'boxful', 'buckaroo', 'buffalo', 'buffoon', 'buxom', 'buzzard', 'buzzing', 'buzzwords', 'caliph',
             'cobweb', 'cockiness', 'croquet', 'crypt', 'curacao', 'cycle', 'daiquiri', 'dirndl', 'disavow',
             ...
             'spritz', 'squawk', 'staff', 'strength', 'strengths', 'stretch', 'stronghold', 'stymied', 'subway',
...
# list to keep track of used letters
used_letters = []

while not end_of_game:
    guess = input("Guess a letter: ").lower()

    # Check if the user has entered a letter they've already guessed
    if guess in used_letters:
        ...
        # Print the number of tries left and used letters
